...
public class URIRunner {
    ...
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        Scanner scanner = new Scanner(urlConnection.getInputStream()); // тоже, что и код ниже
...
//        objectMapper.readValue(/*InputStream inputStream*/, /*value*/) // подзволяет производить маршалин-анмаршалин не локальных объектов
