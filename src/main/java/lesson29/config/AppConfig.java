...
@Configuration
@EnableConfigurationProperties // аннотация, которая говорит, что все бины, помеченные аннотацией @ConfigurationProperties использовать, как бины //({ApplicationProperties.class, SpringProperties.class})
