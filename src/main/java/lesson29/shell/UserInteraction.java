...
//    private static final Logger log = org.slf4j.LoggerFactory.getLogger(UserInteraction.class); // реализация аннотации @Slf4j
...
//    @ShellMethodAvailability("isAvailable")
    ...
    private Availability isAvailable() { // данный метод не должен иметь парамметров и он определяет было ли заполнено поле username,
        // т.е. авторизовался ли пользователь
